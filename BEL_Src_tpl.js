        ...
        window.onkeydown = function(evt) {
            ...
            switch(c){
                case ('l'):
                    ...
                    illumination.light[0].position[0] = Math.cos(.25 * Math.PI + deltaTranslateLight) * radius;
                    illumination.light[0].position[2] = Math.sin(.25 * Math.PI + deltaTranslateLight) * radius;
                    illumination.light[1].position[0] = Math.cos(1.25 * Math.PI + deltaTranslateLight) * radius;
                    illumination.light[1].position[2] = Math.sin(1.25 * Math.PI + deltaTranslateLight) * radius;
                    break;
                case ('L'):
                    deltaTranslateLight += deltaRotate;
                    illumination.light[0].position[0] = Math.cos(.25 * Math.PI + deltaTranslateLight) * radius;
